                                ...
                                <tbody>
                                    {
                                        [1, 2, 3, 4, 5].map((d, i) => 
                                            <tr key={i}> 
                                                ...
                                                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Eazy</td>
                                                ...
                                                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>demo</td>
                                                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>district</td>
                                                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                                    <div className='flex justify-start items-center gap-4'>
                                                        <Link className='p-[6px] bg-green-500 text-white rounded hover:shadow-lg hover:shadow-green-500/50'>
                                                            <FaEye/>
                                                         </Link>
                                                    </div>
                                                </td>
